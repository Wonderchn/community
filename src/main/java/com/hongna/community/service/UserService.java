...
import com.hongna.community.dao.UserMapper;
...
import com.hongna.community.util.MailClient;
...
//        loginTicketMapper.insertLoginTicket(loginTicket);
        ...
        //会自动把loginTicket序列化成一个json字符串而保存只redis中
...
//        loginTicketMapper.updateStatus(ticket, 1);
    ...
    //提供方法供给security使用，判断当前用户是否拥有访问权限
